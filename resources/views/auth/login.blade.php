  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <div class="w-full md:mt-0 sm:max-w-md xl:p-0">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8 text-white ">
              ...
              <hr>
              <h1 class="text-center text-2xl leading-tight tracking-tight md:text-3xl">Masuk</h1>
              <form class="space-y-4 md:space-y-6" action="#">
                  <div>
                      <label for="namapengguna" class="block mb-2 text-xs  text-white">Nama Pengguna</label>
                      <input type="text" name="namapengguna" id="namapengguna" class="bg-gray-50 border border-gray-300 text-gray-900 md:text-xs rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full px-3 placeholder:text-xs " placeholder="Nama Pengguna" required="">
                  </div>
                  <div>
                      <label for="password" class="block mb-2 text-xs text-white">Masukkan Kata Sandi</label>
                      <input type="password" name="password" id="password" placeholder="Kata Sandi" class="bg-gray-50 border border-gray-300 text-gray-900 md:text-xs rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full px-3  placeholder:text-xs " required="">
                  </div>
                  <div class="flex items-center justify-between">
                      <a href="#" class="text-xs text-primary-600 hover:underline hover:text-gradb
