            ...
            <div class="mx-5 sm:mx-10 mt-4">
                ...
                <div class="mb-2 sm:mb-4 lg:mb-8 items-center" data-aos="fade-right" data-aos-offset="150" data-aos-easing="ease-in-sine">
                    <div class="w-full grid grid-cols-3">
                        <div class="flex items-center">
                            <a href="/guest/Detail_Berita">
                                <img class="w-full xl:object-fill xl:w-[419px] xl:h-[236px] 2xl:h-[414px] 2xl:w-[736px] aspect-16/9 hover:brightness-50" src="{{ asset('storage/properti/5.jpg') }}" alt="gambar pelatihan" />
                            </a>
                        </div>
                        <div class="ml-4 md:ml-8 h-16 sm:px-2 md:h-44 md:pt-5 overflow-hidden col-span-2 ">
                            <a href="/guest/Detail_Berita">
                ...
                <div class="mb-2 sm:mb-4 lg:mb-8 items-center" data-aos="fade-right" data-aos-offset="150" data-aos-easing="ease-in-sine">
                    <div class="w-full grid grid-cols-3">
                        <div class="flex items-center">
                            <a href="/guest/Detail_Berita">
                                <img class="w-full xl:object-fill xl:w-[419px] xl:h-[236px] 2xl:h-[414px] 2xl:w-[736px] aspect-16/9 hover:brightness-50" src="{{ asset('storage/properti/4.jpg') }}" alt="gambar pelatihan" />
                            </a>
                        </div>
                        <div class="ml-4 md:ml-8 h-16 sm:px-2 md:h-44 md:pt-5 overflow-hidden col-span-2 ">
                            <a href="/guest/Detail_Berita">
