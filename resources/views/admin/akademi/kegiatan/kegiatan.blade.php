...
<body class="bg-latar text-black min-h-screen">
    ...
    <a href="/admin/kegiatan/tambah" class="bg-nav hover:bg-gradb text-xs md:text-base text-white py-2 px-4 md:px-8
        ...
        <div class="mx-3 my-2">
            ...
            <div class="px-2 md:px-10 items-center my-4" data-aos="fade-right"
                ...
                <div class="w-full grid grid-cols-3">
                    <a href="/admin/kegiatan/detail" class="flex items-center">
                        <img class="w-full aspect-16/9 object-cover hover:brightness-50" src="{{ asset('storage/properti/1.jpg') }}" alt="gambar pelatihan" />    
                    </a>
                    <div class="mx-2 h-20 sm:px-2 sm:h-40 md:h-48  sm:pt-5 overflow-hidden col-span-2 ">
                        <a href="/admin/kegiatan/detail"> 
