...
<body class="bg-latar text-black pb-12 min-h-screen">
    ...
    <div class="fixed left-40 sm:left-56 bottom-16 z-10">
        <a href="/admin/riset" class="bg-nav rounded-r-md hover:bg-gradb text-xs md:text-base text-white py-2 px-4 md:px-8
    ...
    <section class="pt-16 sm:ml-[235px] mx-5 sm:mr-5 relative">
        ...
        <div class="bg-white w-full rounded-md pb-12">
            ...
            <div class="px-5 pt-5 md:px-20 w-full ">
                <img class="object-cover w-4/5 aspect-16/9 rounded-md" src="{{ asset('images/'.$files->photo) }}" alt="detail riset" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="150" data-aos-offset="0">
