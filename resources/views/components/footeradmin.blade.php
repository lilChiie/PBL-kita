    ...
    <div class="grid grid-cols-3 gap-x-3 ">
      <div class="border-r-2 border-black px-5 justify-items-center grid ">
        <div class="grid">
          ...
          <a href="/admin/tentang kami/" class="hover:text-sky-600 text-xs sm:text-base">Tentang Kami</a>
          <a href="/admin/konsultasi/" class="hover:text-sky-600 text-xs sm:text-base">Konsultasi</a>
          <a href="/admin/riset/" class="hover:text-sky-600 text-xs sm:text-base">Riset</a>
          <a href="/admin/publikasi/" class="hover:text-sky-600 text-xs sm:text-base">Publikasi</a>
          <a href="/admin/akademi/" class="hover:text-sky-600 text-xs sm:text-base ">Akademi</a>
          <a href="/admin/berita/" class="hover:text-sky-600 text-xs sm:text-base ">Berita</a>
        </div>        
      </div>
